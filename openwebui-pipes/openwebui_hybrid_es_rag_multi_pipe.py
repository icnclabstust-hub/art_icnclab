"""
title: Hybrid ES RAG（多模型）
author: Art History Database Team
version: 1.0.0
description: BM25 全文檢索 + 向量 kNN（RRF 融合排序），可切換 7 種 LLM 模型
"""
...
class Pipe:
    ...
    def __init__(self):
        self.id = "hybrid_es_rag_multi"
        self.name = ""
        self.valves = self.Valves()

    def pipes(self):
        return [
            {"id": sub_id, "name": f"{llm_name} + Hybrid ES RAG"}
